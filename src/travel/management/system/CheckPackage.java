...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"gold package.jpg","GOLD PACKAGE","4 days and 3 Nights", "Bus And Chander Gari", "Half Day visit Konglak Hill", "Welcome drinks on Arrival", "1 Day Spacial Buffet", "Full Day 3 Resort with top view", "English Speaking Guide", "BOOK NOW", "Winter Special", "5000 Taka only"};
      String[] package2 = new String[]{"home1.jpg","SILVER PACKAGE","3 days and 2 Nights", "Toll Free and Entrance Free Tickets", "Bus", "Welcome drinks on Arrival", "Night Safari", "Full Day See view", "1 Day Spacial Buffet", "BOOK NOW", "Winter & Summer Special", "3000 Taka only"};
      String[] package3 = new String[]{"bronze.jpg","BRONZE PACKAGE","1 Day Special", "Bus & Private Micro", "Sunset View, Horse Riding & other Games", "Welcome drinks on Arrival", "Lunch", "Stay Full Day", "BBQ Dinner", "BOOK NOW", "Summer Special", "1500 Taka only"};
