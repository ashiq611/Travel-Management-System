...
public class Home extends JFrame{
    ...
    public Home(final String username) {
        super("GO-BD");
	this.username = username;
        setForeground(Color.CYAN);
        setLayout(null); 
        setBounds(200, 250, 1200,1000);

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/home.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1950, 1000,Image.SCALE_AREA_AVERAGING);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0,0, 1950, 800 ); 
        add(NewLabel);
        
        JLabel l1 = new JLabel("GO-BD");
	l1.setForeground(Color.WHITE);
        l1.setFont(new Font("Bauhaus 93", Font.PLAIN, 55));
	l1.setBounds(600, 60, 1000, 200);
	NewLabel.add(l1);
        
        JLabel l2 = new JLabel("Traveling is the spice of life");
	l2.setForeground(Color.WHITE);
        l2.setFont(new Font(" Arial Black", Font.PLAIN, 20));
	l2.setBounds(560, 100, 1000, 200);
	NewLabel.add(l2);
	...
	menuBar.add(m5);
        ...
        JMenuItem mi12 = new JMenuItem("PAYMENT METHOD");
	m5.add(mi12);
